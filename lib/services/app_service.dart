...
class AppService {
  ...
  static Future<bool> clearCloneWebArtifactsById(int clonedAppId) async {
    try {
      ...
      debugPrint('clearCloneWebArtifactsById failed: $e');
      return false;
    }
  }

  static Future<bool> enforceFreshLoginById(int clonedAppId) async {
    try {
      final res = await _invokeOptimized<bool>('enforceFreshLoginById', {
        'clonedAppId': clonedAppId,
      });
      return res ?? false;
    } catch (e) {
      debugPrint('enforceFreshLoginById failed: $e');
      return false;
    }
  }

  static Future<bool> clearGlobalWebArtifacts() async {
    try {
      final res = await _invokeOptimized<bool>('clearGlobalWebArtifacts');
      return res ?? false;
    } catch (e) {
      debugPrint('clearGlobalWebArtifacts failed: $e');
      return false;
    }
  }
